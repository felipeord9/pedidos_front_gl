  ...
  return (
    <div className='d-flex justify-content-center align-items-center h-100 w-100 m-auto'>
      <div className='card p-5 border border-4 shadow rounded-4 m-auto' style={{ maxWidth: 400}}>
        ...
        <form className='d-flex flex-column gap-2' style={{fontSize: 13.5}} onSubmit={handleLogin}>
          <div>
          ...
          <button type='submit' className='text-light btn btn-sm' style={{ backgroundColor: '#FE7F20'}}>Ingresar</button>
        </form>
        ...
        <Link to="/enviar/recuperacion" className="text-primary text-center text-decoration-none mt-2">¿Olvidó su contraseña?</Link>
      </div>
    </div>
  )
}